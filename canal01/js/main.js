...
const srcImage = [
    {id:1, url: 'http://natal.ime.usp.br/sinalizacao-digital/img/premio-wilson-kazuo.gif'},
    {id:2, url: 'http://natal.ime.usp.br/sinalizacao-digital/img/classificacaoIme.gif'},
    {id:3, url: 'http://natal.ime.usp.br/sinalizacao-digital/img/pedroPeixoto.gif'},
    {id:4, url: 'http://natal.ime.usp.br/sinalizacao-digital/img/josephYoder.gif'},
...
const cardTese = document.createElement('div')
 ...
 <div class="row">
     <div class="col-3 lateral">
         <p class="lateral-titulo">DEFESA DE ${tese.nivel}</p>
     ...
     <div class="col-9 corpo">
         ...
         <p class="txt-programa-titulo">${tese.programa}</p>
